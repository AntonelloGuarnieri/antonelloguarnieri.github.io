...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(m, p, l) {
...
$jscomp.polyfillUnisolated = function(m, p, l, q) {
    ...
    q = l[m];
    p = p(q);
    p != q && null != p && $jscomp.defineProperty(l, m, {
        configurable: !0,
        writable: !0,
        value: p
    })
...
$jscomp.polyfillIsolated = function(m, p, l, q) {
    ...
    p = p(l);
    null != p && (m ? $jscomp.defineProperty($jscomp.polyfills, k, {
        configurable: !0,
        writable: !0,
        value: p
    }) : p !== l && (void 0 === $jscomp.propertyToPolyfillSymbol[k] && (l = 1E9 * Math.random() >>> 0, $jscomp.propertyToPolyfillSymbol[k] = $jscomp.IS_SYMBOL_NATIVE ?
    $jscomp.global.Symbol(k) : $jscomp.POLYFILL_PREFIX + l + "$" + k), $jscomp.defineProperty(q, $jscomp.propertyToPolyfillSymbol[k], {
        configurable: !0,
        writable: !0,
        value: p
    })))
...
$jscomp.polyfill("Promise", function(m) {
    ...
    function l(g) {
        return g instanceof k ? g : new k(function(n, u) {
            n(g)
        })
    }
    if (m && (!($jscomp.FORCE_POLYFILL_PROMISE || $jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION && "undefined" === typeof $jscomp.global.PromiseRejectionEvent) || !$jscomp.global.Promise || -1 === $jscomp.global.Promise.toString().indexOf("[native code]")))
        return m;
    ...
    k.prototype.resolveTo_ = function(g) {
        if (g === this)
            ...
            n ? this.resolveToNonPromiseObj_(g) :
            this.fulfill_(g)
        }
    };
    ...
    k.prototype.notifyUnhandledRejection_ = function() {
        ...
        "function" === typeof n ? g = new n("unhandledrejection", {
            cancelable: !0
    ...
    k.prototype.then = function(g, n) {
        function u(V, W) {
            return "function" == typeof V ? function(v) {
                try {
                    z(V(v))
                } catch (x) {
                    P(x)
    ...
    k.all = function(g) {
        var n = $jscomp.makeIterator(g),
            u = n.next();
        return u.done ? l([]) : new k(function(z,
        P) {
            function aa(v) {
                return function(x) {
                    V[v] = x;
...
$jscomp.polyfill("Array.prototype.copyWithin", function(m) {
    function p(l) {
        l = Number(l);
        return Infinity === l || -Infinity === l ? l : l | 0
    }
    return m ? m : function(l, q, k) {
        var A = this.length;
        l = p(l);
        q = p(q);
        k = void 0 === k ? A : p(k);
...
var DracoDecoderModule = function() {
    ...
    return function(p) {
        ...
        function k(e, b, c) {
            ...
            for (c = b; e[c] && !(c >= d);)
                ++c;
            if (16 < c - b && e.subarray && Da)
                return Da.decode(e.subarray(b, c));
            for (d = ""; b < c;) {
                var f = e[b++];
                if (f & 128) {
                    var t = e[b++] & 63;
                    if (192 == (f & 224))
                        ...
                        var Y = e[b++] & 63;
                        f = 224 == (f & 240) ? (f & 15) << 12 | t << 6 | Y : (f & 7) << 18 | t << 12 | Y << 6 | e[b++] & 63;
        ...
        function aa(e) {
            for (; 0 < e.length;) {
                ...
                if ("function" == typeof b)
                    ...
                    var c = b.func;
                    "number" === typeof c ? void 0 === b.arg ? ta.get(c)() : ta.get(c)(b.arg) : c(void 0 === b.arg ? null : b.arg)
                }
            }
        }
        function V(e) {
            ...
            this.get_rethrown = function() {
                return 0 !=
                ba[this.ptr + D.RETHROWN_OFFSET >> 0]
            };
        ...
        function W(e) {
            function b() {
                if (!qa && (qa = !0, a.calledRun = !0, !Fa)) {
                    ...
                    if (a.postRun)
                        for ("function" ==
                        typeof a.postRun && (a.postRun = [a.postRun]); a.postRun.length;)
        ...
        var la = {},
            ea;
        for (ea in a)
            a.hasOwnProperty(ea) && (la[ea] = a[ea]);
        var pa = !1,
            fa = !1,
            wa = !1,
            fb = !1;
        ...
        if (wa) {
            ...
            "undefined" != typeof read && (za = function(e) {
                return read(e)
            }),
            oa = function(e) {
                if ("function" ===
            ...
            fa ? X = self.location.href : "undefined" !== typeof document && document.currentScript && (X = document.currentScript.src);
            m && (X = m);
        ...
        (function() {
            ...
            if (a.instantiateWasm)
                try {
                    return a.instantiateWasm(d,
                    e)
                } catch (f) {
                    return ia("Module.instantiateWasm callback failed with error: " + f), !1
                }
            (function() {
                return ka || "function" !== typeof WebAssembly.instantiateStreaming || u(Q, "data:application/octet-stream;base64,") || u(Q, "file://") || "function" !== typeof fetch ? c(b) : fetch(Q, {
                    credentials: "same-origin"
                }).then(function(f) {
        ...
        var hb = a._emscripten_bind_VoidPtr___destroy___0 = function() {
            ...
            ib = a._emscripten_bind_DecoderBuffer_Init_2 = function() {
                return (ib = a._emscripten_bind_DecoderBuffer_Init_2 = a.asm.n).apply(null,
                arguments)
            },
            ...
            Na = a._emscripten_bind_AttributeTransformData_AttributeTransformData_0 = function() {
                return (Na = a._emscripten_bind_AttributeTransformData_AttributeTransformData_0 = a.asm.p).apply(null, arguments)
            },
            kb = a._emscripten_bind_AttributeTransformData_transform_type_0 = function() {
                return (kb = a._emscripten_bind_AttributeTransformData_transform_type_0 = a.asm.q).apply(null,
                arguments)
            },
            ...
            Qa = a._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 = function() {
                return (Qa = a._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 = a.asm.F).apply(null, arguments)
            },
            xb = a._emscripten_bind_AttributeQuantizationTransform_InitFromAttribute_1 = function() {
                return (xb = a._emscripten_bind_AttributeQuantizationTransform_InitFromAttribute_1 = a.asm.G).apply(null,
                arguments)
            },
            ...
            Ab = a._emscripten_bind_AttributeQuantizationTransform_range_0 = function() {
                return (Ab = a._emscripten_bind_AttributeQuantizationTransform_range_0 =
            ...
            Ra = a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 = function() {
                return (Ra = a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 = a.asm.L).apply(null, arguments)
            },
            ...
            Hb = a._emscripten_bind_PointCloud___destroy___0 = function() {
                return (Hb = a._emscripten_bind_PointCloud___destroy___0 = a.asm.S).apply(null,
                arguments)
            },
            ...
            Kb = a._emscripten_bind_Mesh_num_points_0 = function() {
                return (Kb = a._emscripten_bind_Mesh_num_points_0 = a.asm.W).apply(null,
                arguments)
            },
            ...
            Nb = a._emscripten_bind_Status_code_0 = function() {
                return (Nb = a._emscripten_bind_Status_code_0 =
            ...
            qd = a._emscripten_enum_draco_DataType_DT_FLOAT32 = function() {
                return (qd = a._emscripten_enum_draco_DataType_DT_FLOAT32 = a.asm.Kb).apply(null,
                arguments)
            },
        ...
        w.prototype.GetAttributeTransformData = w.prototype.GetAttributeTransformData =
        function() {
        ...
        h.prototype.GetAttributeDataArrayForAllPoints = h.prototype.GetAttributeDataArrayForAllPoints = function(b, c, d, f, t) {
            var Y = this.ptr;
            b && "object" === typeof b && (b = b.ptr);
            c && "object" === typeof c && (c = c.ptr);
            d &&
...
function t(o, a, l, f) {
    ...
    for (const x in h) {
        ...
        if (f.useUniqueIDs)
            ...
            if (w = a.GetAttributeId(p, o[h[x]]), w === -1)
                continue;
